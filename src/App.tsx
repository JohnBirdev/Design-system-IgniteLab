...
export function App() {
  ...
  return (
    <div className='w-screen h-screen bg-grey-900 flex flex-col items-center justify-center text-gray-100'>
      <header className='flex flex-col items-center '>
      <Logo />
      <Heading size='lg' className="mt-4">
        Ignite Lab
      </Heading>
      <Text size='md' color='grey-400' className='mt-1'>
    ...
    <form className='flex flex-col items-stretch w-full max-w-[400px] mt-10 gap-4' autoComplete='off'>
      <label htmlFor="email" className='flex flex-col gap-3'>
        <Text size='md' color='grey-100' className='font-semibold'>Endereço de email</Text>
        <TextInput.Root>
          <TextInput.Icon>
            <Envelope />
          </TextInput.Icon>
      ...
      <label htmlFor="password" className='flex flex-col gap-3'>
        <Text size='md' color='grey-100' className='font-semibold'>Senha</Text>
        <TextInput.Root>
          <TextInput.Icon>
            <LockSimpleOpen />
          </TextInput.Icon>
    ...
    <footer className='flex flex-col items-center gap-[18px] mt-8 underline '>
      <Text asChild size='sm' color='grey-400'>
